...
class SettingsProvider with ChangeNotifier {
  ...
  static const _countHoldOnTotalKey = 'count_hold_on_total';
  ...
  bool get countHoldOnTotal => _countHoldOnTotal;
  ...
  Future<void> loadSettings() async {
    ...
    _countHoldOnTotal = prefs.getBool(_countHoldOnTotalKey) ?? true;
  ...
  Future<void> setCountHoldOnTotal(bool enabled) async {
    _countHoldOnTotal = enabled;
    notifyListeners();
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool(_countHoldOnTotalKey, enabled);
  }
