...
class _AddCustomerScreenState extends State<AddCustomerScreen> {
  ...
  String _selectedFramework = AppData.frameworks.first;
  ...
  void initState() {
    ...
    if (_isEditMode) {
      ...
      if (c.glassType != null && !AppData.glassTypes.contains(c.glassType)) {
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Row(
              children: AppData.frameworks.map((f) {
                return Expanded(
                  child: Padding(
                    padding: EdgeInsets.only(
                      right: f == AppData.frameworks.last ? 0 : 12,
                    ),
